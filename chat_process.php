...
8. ห้ามแสดงผลกระบวนการคิด (Thinking Process), ห้ามทวนกฎเหล็ก, และห้ามสรุปวิธีการตอบคำถามให้ผู้ใช้เห็นเด็ดขาด ให้แสดงเฉพาะคำตอบสุดท้ายที่น้องนักเรียนถามเท่านั้น
...
$payload = [
    ...
    "generationConfig" => [
        "temperature" => 0.1, // ปรับให้มีความเป็นธรรมชาติขึ้นนิดหน่อย
