...
$isDressCode = preg_match('/(แต่งกาย|ชุดนักเรียน|ม\.ต้น|ม\.ปลาย|มัธยมต้น|มัธยมปลาย|ทรงผม|ถุงเท้า|รองเท้า|เข็มขัด|โบว์|ลูกเสือ|เนตรนารี|ชุดพละ|ชุดสี)/u', $userMessageRaw);
...
if ($cat === 'identity' || $cat === 'motto' || ($isHistory && $cat === 'history') || ($isMap && $cat === 'map') || ($isDressCode && $cat === 'uniform')) {
    
    // ถ้าเป็นหมวดรูปภาพ ให้ใส่ป้ายกำกับชัดๆ ใน Context
...
5. การแสดงรูปภาพ (สำคัญมาก): 
   ...
   - **ห้ามเว้นวรรคหรือขึ้นบรรทัดใหม่ใน URL เด็ดขาด** เขียนให้ยาวต่อเนื่องกันในบรรทัดเดียว
