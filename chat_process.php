...
if ($cat === 'identity' || $cat === 'motto' || 
    ...
    // ถ้าเป็นหมวดที่มีรูปภาพ ให้ระบุชัดๆ ไปเลย
...
5. การแสดงรูปภาพ (สำคัญมาก): 
   - หากข้อมูลมีป้ายกำกับ [IMAGE_URL] หรือพบลิงก์ .jpg, .png ให้แสดงภาพทันทีด้วยแท็ก:
     <img src='URL' class='w-full rounded-lg shadow-md my-2' alt='คำอธิบาย'>
   - **ห้ามปฏิเสธว่าไม่มีรูปภาพ** หากมีลิงก์ปรากฏอยู่ในฐานข้อมูล
   - ห้ามเว้นวรรคหรือขึ้นบรรทัดใหม่ใน URL เด็ดขาด
   - หากถามถึง "เครื่องแบบ" หรือ "ชุด" ให้แสดงภาพที่เกี่ยวข้องทั้งหมดเรียงต่อกัน
6. ลักษณะการตอบ: 
