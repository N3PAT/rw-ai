...
5. การแสดงรูปภาพ: 
   - หากน้องถามถึงแผนผัง ให้ตอบแค่ข้อความสั้นๆ แล้วปิดท้ายด้วยบรรทัดใหม่ และตามด้วย URL นี้ '{$context['map_url']}' เท่านั้น
   - ห้ามใส่ 'Link' หรือ 'คำอธิบาย' นำหน้า URL
   - **ห้ามเว้นวรรคหรือขึ้นบรรทัดใหม่ภายในตัว URL เด็ดขาด**
