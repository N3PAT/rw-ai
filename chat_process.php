...
// 🔥 OPTIMIZE 1: รับและเช็คข้อความก่อนต่อ DB เพื่อลดการเปิด Connection ฟรี
...
// --- 3. SMART LOAD ENGINE (Context Preparation) ---
$context = [
...
// ค้นหาบรรทัด $isFinance แล้วเปลี่ยนเป็น:
...
// 🔥 OPTIMIZE 2: ดึงข้อมูลผู้บริหารเฉพาะเมื่อโดนถามเท่านั้น
if ($isAdmin) {
...
// 🔥 OPTIMIZE 2: ดึงเกณฑ์พฤติกรรมเฉพาะเมื่อโดนถามเท่านั้น
if ($isBehavior) {
...
// 3.2 ระบบ Keyword Matching สำหรับอาคาร กฎ ระเบียบ แผนการเรียน (คงเดิม)
$keywords = [
...
// เพิ่มในส่วน [กฎเหล็กที่ต้องทำตามอย่างเคร่งครัด]
6. ข้อมูลค่าเทอม: หากมีการถามเรื่องค่าเทอม ให้สรุปแยกเป็น ม.ต้น และ ม.ปลาย ตามข้อมูลที่มีในฐานความรู้ และระบุว่าเป็นราคาโดยประมาณเสมอ
...
if ($success && !empty($aiResponse)) {
    // 🔥 OPTIMIZE 3: ลบข้อมูลเก่าแบบสุ่ม (มีโอกาส 1 ใน 20 ที่จะรันคำสั่งนี้) ลดภาระ Database Lock
    if (rand(1, 20) === 1) {
