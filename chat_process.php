...
5. การแสดงรูปภาพ: 
   - หากถามถึงแผนผัง ให้ตอบข้อความแล้วปิดท้ายด้วยลิงก์นี้ '{$context['map_url']}' (ห้ามเว้นวรรคหรือขึ้นบรรทัดใหม่ในตัวลิงก์เด็ดขาด)
   - หากมี Image:URL ในฐานข้อมูล ให้แสดง URL นั้นปิดท้ายคำตอบโดยพิมพ์ติดกันเป็นเส้นเดียว
   - **ห้ามใส่แท็ก HTML หรือ Markdown ให้ส่งแค่ URL เปล่าๆ เท่านั้น**
