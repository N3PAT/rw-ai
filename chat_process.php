...
// แก้จากเดิมที่ดึง getenv ให้เป็นชื่อรุ่นโดยตรง
...
$payload = [
    ...
    "generationConfig" => [
        "temperature" => 0.2,       // ปรับให้มีความเป็นธรรมชาติมากขึ้น (Gemma 3 12B คุมบทบาทได้ดี)
        "maxOutputTokens" => 1500,  // เพียงพอสำหรับคำตอบยาวๆ หรือเนื้อเพลง
        "topP" => 0.9,
        "topK" => 40
    ]
];
