...
if (isUser) {
    ...
    msgHtml = `
    <div class="flex justify-end msg-animate origin-bottom-right w-full">
        <div class="flex flex-col items-end max-w-[85%] md:max-w-[75%]">
            <div class="bg-blue-600 text-white p-3.5 px-4 md:p-4 md:px-5 rounded-2xl rounded-br-none shadow-md text-sm md:text-base leading-relaxed msg-text w-fit">${safeMessage}</div>
